...
type LocalUserObserver struct {
	...
	*/
	...
	// ryou add
	OnAudioTrackPublishStart   func(localUser *LocalUser, localAudioTrack *LocalAudioTrack)
	OnAudioTrackPublishSuccess func(localUser *LocalUser, localAudioTrack *LocalAudioTrack)
}
